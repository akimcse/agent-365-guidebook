...
| 버전 | 날짜 | 요약 |
|------|------|------|
| v1 | 2026-07-08 | 최초 공개본: 홈 + 심화 문서(유형 분류·신원/위험·런타임 위협 탐지) |
| v2 | 2026-07-16 | 런타임 위협 탐지를 3계층 탐지 모델로 재구성 |
| v3 | 2026-07-19 | 런타임 위협 탐지 실시간보호 vs 탐지·조사 섹션 정리 |
| v6 | 2026-07-20 | 부록 '데모 시나리오' 추가(4계층 탐지 검증) |
| v7 | 2026-07-20 | 심화 문서 '데이터 보안 · Purview' 추가(런타임 위협 탐지는 ④로 이동) |
