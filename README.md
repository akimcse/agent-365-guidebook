...
| 버전 | 날짜 | 요약 | 커밋 |
|------|------|------|------|
| v1 | 2026-07-08 | 최초 공개본: 홈 + 심화 문서(유형 분류·신원/위험·런타임 위협 탐지) | [`ec29891`](https://github.com/akimcse/agent-365-guidebook/commit/ec29891) |
| v2 | 2026-07-16 | 런타임 위협 탐지를 3계층 탐지 모델로 재구성 | [`d88b6ee`](https://github.com/akimcse/agent-365-guidebook/commit/d88b6ee) |
| v3 | 2026-07-19 | 런타임 위협 탐지 실시간보호 vs 탐지·조사 섹션 정리 | [`0fcd4d3`](https://github.com/akimcse/agent-365-guidebook/commit/0fcd4d3) |
| v4 | 2026-07-20 | 부록 '데모 시나리오' 추가(4계층 탐지 검증) | [`c74d9ab`](https://github.com/akimcse/agent-365-guidebook/commit/c74d9ab) |
| v5 | 2026-07-20 | 심화 문서 '데이터 보안 · Purview' 추가(런타임 위협 탐지는 ④로 이동) | [`6f39267`](https://github.com/akimcse/agent-365-guidebook/commit/6f39267) |
