...
| 버전 | 날짜 | 요약 | 커밋 | 배포 |
|------|------|------|------|------|
| v1 | 2026-07-08 | 최초 공개본: 홈 + 심화 문서(유형 분류·신원/위험·런타임 위협 탐지) | [`ec29891`](https://github.com/akimcse/agent-365-guidebook/commit/ec29891) | [run](https://github.com/akimcse/agent-365-guidebook/actions/runs/28931670211) |
| v2 | 2026-07-16 | 런타임 위협 탐지를 3계층 탐지 모델로 재구성 | [`a545b85`](https://github.com/akimcse/agent-365-guidebook/commit/a545b85) | [run](https://github.com/akimcse/agent-365-guidebook/actions/runs/29482267378) |
| v3 | 2026-07-19 | 런타임 위협 탐지 실시간보호 vs 탐지·조사 섹션 정리 | [`0fcd4d3`](https://github.com/akimcse/agent-365-guidebook/commit/0fcd4d3) | [run](https://github.com/akimcse/agent-365-guidebook/actions/runs/29691986260) |
...
| v6 | 2026-07-24 | 심화 문서 '거버넌스 프레임워크' 추가(에이전트 액션 흐름·게이트별 MS 매핑·전체 한판 아키텍처) | [`0a608d9`](https://github.com/akimcse/agent-365-guidebook/commit/0a608d9) | [run](https://github.com/akimcse/agent-365-guidebook/actions/runs/30060526577) |
